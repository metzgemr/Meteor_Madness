...
<script type="text/javascript">
    setBackground('../images/locations/nemo_day.png', '../images/locations/nemo_night.png');
</script>

<?php
$locationTitle = "POINT NEMO";
$locationImageUrl = "../images/location-titles/nemo_title.png";
